...
import 'package:hive_todo/hive_helper.dart';
        ...
        builder: (BuildContext ctx) {
          return AlertDialog(
            ...
            actions: [
              TextButton(
                  onPressed: () {
                    HiveHelper.deleteItem(context, id);
                    setState(() {});
                  },
          ...
          onPressed: () {
            if (formKey.currentState!.validate()) {
              if (todoModel == null) {
                ...
                HiveHelper.updateItem(todoModel);
              }
              Navigator.of(context).pop();
              setState(() {});
            }
